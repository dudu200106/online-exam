package com.onlineexam.exception.handler;

import com.onlineexam.exception.OeServiceException;
import com.onlineexam.util.restful.JsonResult;
...
public class GlobalControllerExceptionHandler {
     ...
     * 处理业务异常
     */
    @ExceptionHandler({OeServiceException.class})
    public JsonResult<Void> handleCoolSharkServiceException(OeServiceException e) {
